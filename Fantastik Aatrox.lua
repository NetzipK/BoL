...
function AMenu()
	...
	elseif _Pewalk then
		PrintChat("<font color = \"#FFFFFF\">[Fantastik Aatrox] </font><font color = \"#FF0000\">Pewalk Status:</font> <font color = \"#FFFFFF\">Successfully integrated.</font> </font>")
		AMenu:addParam("PEWON","[Aatrox] Pewalk support is active.", 5, "")
		isPEW = true
	elseif not _G.Reborn_Loaded and not _Pewalk then
		require "SxOrbWalk"
